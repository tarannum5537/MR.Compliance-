...
const SERVICES = [
  ...
  { label: "ISO 27001 Certification", slug: "iso-27001-certification-services" },
    ...
    <footer className="footer">
      <div className="footer__inner">
        <div className="footer__brand">
          ...
          <p>
            Mr. Compliance helps growing companies build, implement, and
            operate their security and compliance programs - so they can win
            enterprise customers, reduce risk, and scale with confidence.
          </p>
        </div>
        ...
        <div className="footer__col">
          ...
          <div className="footer__office">
            ...
            <span>
              15, 2nd floor, cross road buildings Wakad pune 411057
            </span>
          </div>
          <div className="footer__office">
            <strong>USA</strong>
